...
select kh.ma_khach_hang,kh.ho_ten,lk.ten_loai_khach,hd.ma_hop_dong,dv.ten_dich_vu,hd.ngay_lam_hop_dong,hd.ngay_ket_thuc,sum(dvdk.gia*hdct.so_luong+dv.chi_phi_thue) as tong_tien
from khach_hang kh
